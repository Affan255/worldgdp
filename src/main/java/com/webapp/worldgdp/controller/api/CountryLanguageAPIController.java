...
import com.webapp.worldgdp.dao.CountryLanguageDao;
...
public class CountryLanguageAPIController {
    ...
    public ResponseEntity<?> getLanguages(@PathVariable String countryCode, @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo) {
        try {
